  ...
  return (
    <section className={classes.masters}>
      ...
      <ul className={classes.masters__list}>
        {masters.map(master =>
          <li className={classes.masters__item} key={String(master._id)}>
            <div>
            ...
            <div className={classes.masters__item_button}>
              <Link className={classes.masters__button_edit} to={master._id} onClick={() => dispatch(interfaceSlice.actions.setMastersModal('edit'))}>
              ...
              <Link className={classes.masters__button_delete} to={master._id} onClick={() => dispatch(interfaceSlice.actions.setMastersModal('delete'))}>
